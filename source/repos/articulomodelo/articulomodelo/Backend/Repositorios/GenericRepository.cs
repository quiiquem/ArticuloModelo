...
namespace articulomodelo.Backend.Servicios
{
    ...
    public class GenericRepository<T> : IGenericRepository<T> where T : class
    {
        ...
        public async Task AddAsync(T entity)
        {
            ...
            {
                _logger.LogError(ex, "Error de concurrencia al añadir la entidad de tipo {EntityType}.", typeof(T).FullName);
                throw new DataAccessException("Error de concurrencia al añadir la entidad.", ex);
            }
